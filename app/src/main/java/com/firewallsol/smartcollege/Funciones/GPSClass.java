...
public class GPSClass extends Service implements LocationListener {
	...
	private static final long MIN_TIME_BW_UPDATES = 1000 * 1 * 1; // 5 segundos
	...
	public void showSettingsAlert(){
        ...
        alertDialog.setMessage("El GPS no esta activo. ¿Te gustaría ir a las configuraciones para activarlo?");
