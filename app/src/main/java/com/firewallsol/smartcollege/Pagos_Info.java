...
public class Pagos_Info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagos__info);
        ...
        Cursor alumn = db.rawQuery("select * from hijos where id = '" + MainActivity.alumno + "'", null);
        if (alumn.moveToFirst()) {
            ((TextView) findViewById(R.id.infoPago)).setText(alumn.getString(8));
        }
        alumn.close();
        ...
        findViewById(R.id.infoPago).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClipboardManager clipboard = (ClipboardManager) getSystemService(CLIPBOARD_SERVICE);
                clipboard.setText(((TextView) findViewById(R.id.infoPago)).getText());
    ...
    private void CustomActionBar() {
        ...
        textoPrincipal.setText("INFORMACIÓN DEL PAGO");
